...
if(isset($_POST["submit1"]))
{
    $link=mysqli_connect("localhost","root","");
    mysqli_select_db($link,"admin_login");
    mysqli_query($link,"insert into checkout_address values('','$_POST[firstname]','$_POST[lastname]','$_POST[email]','$_POST[address]','$_POST[city]','$_POST[pincode]','$_POST[contactno]')");
?>
<script type="text/javascript">
alert("your address saved successful");
</script>
<?php
